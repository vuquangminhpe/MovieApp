...
interface RenderMoviesProps {
  ...
  CustomIMG?: string
  tv_id: number
  setTV_ID: React.Dispatch<React.SetStateAction<number | undefined>>
  voteRate: number
  media_type?: string
}
...
const RenderTVDetails = ({
  ...
  const deletedRatingMutation = useMutation({ mutationFn: () => DetailsMovieApi.deleteRating(tv_id) })
      ...
      <div className='absolute top-2 right-2 z-10'>
        <div className='w-6 h-6 flex items-center justify-center cursor-pointer'>
          <Pops>
            <PopoverTrigger>
              {' '}
              <span onClick={() => setTV_ID(tv_id)} className='text-gray-400 text-xl'>
                ⋮
              </span>
            </PopoverTrigger>
            <PopoverContent>
                  ...
                  <PopoverContent>
                    <div className='bg-blue-950 inline-block p-3 rounded-xl shadow-sm translate-x-20'>
                      ...
                      <div className='flex justify-start items-center text-center'>
                        ...
                        <InputStar initialRating={voteRate} id={tv_id as number} />
                      </div>
                    </div>
                  </PopoverContent>
                </Pops>
