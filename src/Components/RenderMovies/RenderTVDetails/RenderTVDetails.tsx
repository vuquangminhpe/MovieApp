...
interface RenderMoviesProps {
  dataTVDetails?: CastMember | MovieCast | videosDetails | Aggregate_Credits
        ...
        >
          ...
          <div>
            <img
              ...
              src={
                (dataTVDetails as CastMember).profile_path == null
                  ? 'https://www.themoviedb.org/assets/2/v4/glyphicons/basic/glyphicons-basic-4-user-grey-d8fe957375e70239d6abdd549fd7568c89281b2179b5f4470e2e12895792dfa5.svg'
                  : `${configBase.imageBaseUrl}${(dataTVDetails as CastMember).profile_path}`
              }
            />
          </div>
        </div>
